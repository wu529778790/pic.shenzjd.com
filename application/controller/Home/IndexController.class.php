<?php
namespace application\controller\Home; @eval("//Encode by  phpjiami.com,Free user."); 
...
class IndexController extends Controller{
	...
	public function IndexAction(){
		...
		$out = ob_get_clean();
		$out = str_replace('<span class="yright"></span><br>','<span class="yright">本站由轻量级图床程序<a href="https://pic.shenzjd.com/" title="极简空间免费图床" style="color:red;">极简空间</a>强力驱动</span><br>',$out);
		$out = str_replace('<!--','',$out);
		$out = str_replace('-->','',$out);
		if(!strpos($out,'<span class="yright">本站由轻量级图床程序<a href="https://pic.shenzjd.com/" title="极简空间免费图床" style="color:red;">极简空间</a>强力驱动</span><br>')){
			header("Location: https://pic.shenzjd.com/service/copyright.html");
			$out = '';
			exit;
		}
		echo($out);
